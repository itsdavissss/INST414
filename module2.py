...
# Visualize Network: Top 25 Influential Voters 
top_eigenvector_voters = sorted(eigenvector_centrality.items(), key=lambda x: x[1], reverse=True)[:25]
...
plt.title("Wikipedia RfA Network (Top 25 Most Influential Voters)")
plt.axis('off')
plt.show()